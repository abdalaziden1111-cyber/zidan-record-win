...
export const RECORDLY_ISSUES_URL = "https://github.com/abdalaziden1111-cyber/zidan-record-win/issues";
			...
			<DialogContent className="max-w-lg bg-editor-dialog border-foreground/10 [&>button]:text-muted-foreground [&>button:hover]:text-foreground">
				...
				<div className="mt-4 space-y-4">
					...
					<p className="text-center text-[11px] text-muted-foreground/60">
						Zidan Record by Abdallah Zidan — based on Recordly (AGPL-3.0), which derives
						from OpenScreen.
					</p>
				</div>
			</DialogContent>
