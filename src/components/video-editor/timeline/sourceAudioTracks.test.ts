...
describe("timeline source audio tracks", () => {
	it("builds candidates for Windows and macOS sidecar containers", () => {
		expect(buildSourceSidecarPathCandidates("C:\\Zidan Record\\recording-1.mp4", "mic")).toEqual([
			"C:/Zidan Record/recording-1.mic.wav",
			"C:/Zidan Record/recording-1.mic.m4a",
			"C:/Zidan Record/recording-1.mic.webm",
		]);
	});
