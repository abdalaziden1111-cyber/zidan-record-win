...
// Relative tiers ("medium"…"source") scale from the source resolution and are
// kept for backward compatibility with saved projects/preferences. Absolute
// tiers ("720p"…"4k") target a fixed resolution, capped at the source size.
...
export const ABSOLUTE_EXPORT_QUALITY_DIMENSIONS: Record<
	"720p" | "1080p" | "2k" | "3k" | "4k",
...
export function isAbsoluteExportQuality(
	quality: ExportQuality,
): quality is "720p" | "1080p" | "2k" | "3k" | "4k" {
	return quality in ABSOLUTE_EXPORT_QUALITY_DIMENSIONS;
}
