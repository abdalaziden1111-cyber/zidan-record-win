...
describe("resolveExperimentalNvidiaCudaExportScriptPath", () => {
	it("prefers the packaged app.asar.unpacked CUDA wrapper over the virtual app.asar copy", async () => {
		...
		try {
			...
			const resourcesPath = "C:\\Zidan Record\\resources";
			const unpackedScriptPath =
				"C:\\Zidan Record\\resources\\app.asar.unpacked\\electron\\native\\nvidia-cuda-compositor\\run-mp4-pipeline.mjs";
			const asarScriptPath =
				"C:\\Zidan Record\\resources\\app.asar\\electron\\native\\nvidia-cuda-compositor\\run-mp4-pipeline.mjs";
			Object.defineProperty(process, "resourcesPath", {
				configurable: true,
				value: resourcesPath,
			});
			electronAppMock.getAppPath.mockReturnValue("C:\\Zidan Record\\resources\\app.asar");
