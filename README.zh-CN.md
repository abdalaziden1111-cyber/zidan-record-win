...
<p align="center">
  <img width="220" alt="Zidan Record logo" src="https://github.com/user-attachments/assets/082bb4b0-5fc5-4e9f-abda-55611fd6aded" />
</p>
...
### 无需额外剪辑，也能做出精致的屏幕录制。
[Zidan Record](https://www.recordly.dev) 是一款**开源屏幕录制器**和编辑器，适合制作**操作讲解、演示、产品视频**等内容。  
...
Zidan Record 是一款桌面应用，用于录制并编辑屏幕内容，内置面向演示视频的动态呈现工具。你不需要再把原始素材交给动效设计师去补缩放、光标润色或样式化背景，Zidan Record 可以在一个地方免费完成整套流程。
...
## 自动缩放、光标润色与样式化画面
Zidan Record 可以根据操作自动强调重点区域，平滑光标运动，添加动态效果，并将最终画面放进带有壁纸、纯色、渐变、模糊、留白和阴影的样式化边框中。

<p>
  <img src="./docs/media/feature1.gif" width="450" alt="Zidan Record cursor and zoom demo video">
</p>
...
<p>
  <img src="./docs/media/feature2.gif" width="450" alt="Zidan Record webcam overlay demo video">
</p>
...
Zidan Record 拥有一个社区驱动的扩展系统。任何人都可以构建和发布扩展来为 Zidan Record 添加新功能，例如光标点击音效、设备边框、浏览器模拟外壳、壁纸、渲染钩子、设置面板等等。

浏览并安装社区扩展：[Zidan Record 扩展市场](https://marketplace.recordly.dev/extensions)。
...
<p align="center">
  <img src="https://i.postimg.cc/8CrQtGJf/Screenshot-2026-04-30-at-5-11-52-pm.png" width="700" alt="Zidan Record recording interface screenshot">
</p>

<p align="center">
  <img src="https://i.postimg.cc/pLSMfrTM/Screenshot-2026-04-30-at-5-11-45-pm.png" width="700" alt="Zidan Record editor screenshot">
</p>

<p align="center">
  <img src="https://i.postimg.cc/Zn9VY6bg/Screenshot-2026-03-18-at-6-32-59-pm.png" width="700" alt="Zidan Record timeline screenshot">
</p>
...
https://github.com/abdallah-zidan/zidan-record/releases
...
```bash
git clone https://github.com/abdallah-zidan/zidan-record.git recordly
cd recordly
npm install
npm run dev
```
...
```bash
xattr -rd com.apple.quarantine /Applications/Zidan Record.app
```
...
Zidan Record 会在录制画面上渲染一个经过美化的光标叠加层，但真实系统光标是否能被隐藏仍取决于平台能力。
...
Zidan Record 将平台相关的捕获层与基于渲染器的编辑、导出流程结合在一起。
...
https://github.com/abdallah-zidan/zidan-record/issues
...
Zidan Record 最初是从 [OpenScreen](https://github.com/siddharthvaddem/openscreen) 分叉而来，之后已逐步演变为一个不同的项目。
